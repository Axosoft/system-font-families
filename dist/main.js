...
var tableToObj = function tableToObj(obj, postscript, file, systemFont) {
    return {
        family: obj['1'],
        subFamily: obj['2'],
        postscript: obj['6'],
        ...
        monospace: postscript.isFixedPitch
    };
};
...
var extendedReducer = function extendedReducer(m, _ref) {
    ...
    if (m.has(family)) {
        ...
        return m.set(family, _extends({}, origFont, {
            ...
            monospace: _extends({}, origFont.monospace, _defineProperty({}, subFamily, monospace))
        }));
    } else {
        return m.set(family, {
            family: family,
            ...
            monospace: _defineProperty({}, subFamily, monospace)
        });
    }
};
